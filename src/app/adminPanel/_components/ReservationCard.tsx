...
export default function ReservationCard({ reservation, onEdit, onDelete, isPending }: ReservationCardProps) {
  ...
  return (
    <div className="reservation-card border shadow p-4 bg-white rounded relative min-h-[200px]"> {/* Style z Blazora */}
      {/* Przyciski akcji */}
      ...
      {/* Dane rezerwacji */}
      <div onClick={onEdit} className="cursor-pointer"> {/* Kliknięcie całej karty też edytuje */}
        <h2 className="text-xl font-semibold mb-2">{reservation.firstName} {reservation.lastName}</h2>
        ...
        <p className="mb-0 reservation-annotation text-sm text-gray-600 overflow-auto max-h-16"> {/* Style z Blazora */}
